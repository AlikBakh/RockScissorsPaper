...
namespace RSP
{
    public partial class TCP : Form
    {
        ...
        {
            timer1.Start();
            DataTCP.Text = DateTime.Now.ToLongDateString();
            TimeTCP.Text = DateTime.Now.ToLongTimeString();
        }


        private void HelpTCP_Click(object sender, EventArgs e)//Вывод правил игры.
        {
        ...
        private void ExitTCP_Click(object sender, EventArgs e)//Выход из игры с последующим подтверждением.
        {
        ...
        private void ExitTCP_MouseEnter(object sender, EventArgs e)//регулировка цвета при наведении на кнопку "выход"
        {
            ExitTСP.ForeColor = Color.Red;
        }
        private void ExitTCP_MouseLeave(object sender, EventArgs e)//возврат исходного цвета
        {
            ExitTСP.ForeColor = Color.White;
        }


        private void SvernutTCP_Click(object sender, EventArgs e)//свернуть окно
        {
            this.WindowState = FormWindowState.Minimized;
        }
        private void SvernutTCP_MouseEnter(object sender, EventArgs e)//регулировка цвета при наведении на кнопку "свернуть"
        {
            SvernutTСP.ForeColor = Color.Red;
        }
        private void SvernutTCP_MouseLeave(object sender, EventArgs e)//возврат исходного цвета
        {
            SvernutTСP.ForeColor = Color.White;
        }
